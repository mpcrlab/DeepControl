# policy_collect.py leaves float64 pixels, which increases RAM consumption,
...
if __name__ == "__main__":
    ...
    directory += raw_input("Input folder name from /media/mpcr/Storage/deepcontrol/sim-datasets/: ")
    convert_float(directory)
